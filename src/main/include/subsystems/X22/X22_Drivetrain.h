...
private:
    ...
    frc::DifferentialDriveWheelSpeeds   ws_PV;//, ws_chassis;
    ...
    nt::NetworkTableEntry ntDriveValid, ntInLowGear, ntInHighGear;
    nt::NetworkTableEntry ntRampTime;
    nt::NetworkTableEntry ntLeftVel, ntRightVel;
    nt::NetworkTableEntry ntLeftEnc_Raw, ntRightEnc_Raw;
    ...
    wpi::StringMap<std::shared_ptr<nt::Value>> props_enc_values =
    {
        std::make_pair("min", nt::Value::MakeDouble(3000.0)),
        std::make_pair("max", nt::Value::MakeDouble(3000.0))
    };
};
